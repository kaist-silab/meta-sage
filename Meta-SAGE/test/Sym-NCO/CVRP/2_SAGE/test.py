...
run_params = {
    ...
    'test_data_load': {
        'enable': True,
        'filename': '../0_test_dataset/X/X-n219-k73.vrp',
...
def parse_args(arg_str = None):
    ...
    #     run_params['test_data_load']['filename'] = args.filename

    # env_params['problem_size'] = int(args.filename.split('/')[-1].split('-')[1][1:4]) - 1
