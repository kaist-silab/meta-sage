...
run_params = {
    ...
    'test_data_load': {
        'enable': True,
        'filename': '../0_test_dataset/vrp1000_main_table_seed1234.pkl',
        'index_begin': 0
    },
    'num_episodes': 128,
...
from similarity_tester import CVRPTester as Tester
...
def parse_args(arg_str = None):
    ...
    if env_params['problem_size'] == 200:
        run_params['test_data_load']['filename'] = '../0_test_dataset/vrp200_test_seed1235.pkl'
    elif env_params['problem_size'] == 500:
        run_params['test_data_load']['filename'] = '../0_test_dataset/vrp500_main_table_seed1234.pkl'
    elif env_params['problem_size'] == 1000:
        run_params['test_data_load']['filename'] = '../0_test_dataset/vrp1000_main_table_seed1234.pkl'
