...
class LabelTrainer:
    ...
    def run(self):
        ...
        np.save('./emb_label/symnco_tsp_label_{}_{}_{}'.format(self.env_params['pomo_size'], self.run_params['eas_num_iter'], self.run_params['num_episodes']),embedding_label)
            ...
            while not done:
                if distance_matrix != None:
                    if state.current_node != None:
                        ...
                        distance = None
                selected, prob = self.model(state, distance)
