...
class CVRP_SML_Trainer:
    ...
    def run(self):
        ...
        np_load_200 = np.load('./emb_label/symnco_cvrp_label_200_100_3000.npy')
        np_load_300 = np.load('./emb_label/symnco_cvrp_label_300_100_3000.npy')
        np_load_400 = np.load('./emb_label/symnco_cvrp_label_400_100_3000.npy')
        ...
        while(epoch < 2):
            ...
            torch.save({
                ...
                }, "../pretrained/symnco_cvrp_with_sml.pt")
