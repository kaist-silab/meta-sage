...
run_params = {
    ...
    'train_data_load': {
        'enable': True,
        'filename': ['../../../../../data_generation/data/train/vrp/vrp200_train_seed12345.pkl', '../../../../../data_generation/data/train/vrp/vrp300_train_seed12345.pkl','../../../../../data_generation/data/train/vrp/vrp400_train_seed12345.pkl'],
        'index_begin': 0,
    },
...
import argparse
from CVRP_SML_Trainer import CVRP_SML_Trainer as Trainer
