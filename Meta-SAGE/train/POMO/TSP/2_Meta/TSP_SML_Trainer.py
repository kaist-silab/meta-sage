...
class TSP_SML_Trainer:
    ...
    def run(self):
        ...
        np_load_200 = np.load('./emb_label/pomo_tsp_label_200_100_3000.npy')
        np_load_300 = np.load('./emb_label/pomo_tsp_label_300_100_3000.npy')
        np_load_400 = np.load('./emb_label/pomo_tsp_label_400_100_3000.npy')
        ...
        torch.save({
                ...
                }, "../pretrained/pomo_tsp_with_sml.pt")
    ...
    def train_scale_bias(self, target):
        ...
        while not done:
            selected, prob = self.model(state, map_feat)
