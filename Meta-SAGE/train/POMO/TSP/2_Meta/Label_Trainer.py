...
class LabelTrainer:
    def __init__(self,
        ...
        self.embedding_label = torch.empty(size=(run_params['num_episodes'],env_params['pomo_size'],model_params['embedding_dim']))
    ...
    def run(self):
        ...
        np.save('./emb_label/pomo_tsp_label_{}_{}_{}'.format(self.env_params['pomo_size'], self.run_params['eas_num_iter'], self.run_params['num_episodes']),embedding_label)
    ...
    def _run_eas(self, num_iter=1, initial=True):
    ...
    def _eas_one_batch(self, episode, batch_size, num_iter, optimizer=None):
