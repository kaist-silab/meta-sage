...
class SML_Model(TSPModel):
    ...
    def pre_forward(self, reset_state, map_feat=None):  # now includes decoder.set_q1
        ...
        # x = math.log(self.encoded_nodes.shape[1]/100)
        ...
        # scale_bias = self.proj_N_h(self.encoded_nodes)
    ...
    def forward(self, state, map_feat=None):
        ...
        if state.current_node is None:
            ...
            probs = self.decoder(encoded_last_node, ninf_mask=state.ninf_mask, first_node=state.first_node, map_feat=map_feat)
...
class E_TSP_Decoder(TSP_Decoder):
    ...
    def forward(self, encoded_last_node, ninf_mask, first_node=None, map_feat=None):
